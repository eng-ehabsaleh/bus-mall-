...
firstimg.addEventListener('click', handler); 
secondimg.addEventListener('click', handler);
thirdimg.addEventListener('click', handler);
...
function renderlist(){
    ...
    function handelclick(){
        ...
        khabi.removeEventListener('click',handelclick);
        button.removeEventListener('click',handelclick);

        firstimg.removeEventListener('click',handler);
        secondimg.removeEventListener('click',handler);
        thirdimg.removeEventListener('click',handler);
